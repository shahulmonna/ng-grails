			...
			<ol class="property-list evaluation">
				...
				<li class="fieldcontain">
					<span id="speech-label" class="property-label"><g:message code="evaluation.speech.label" default="Speech" /></span>
						...
						<span class="property-value" aria-labelledby="speech-label"><g:link controller="speech" action="show" id="${evaluationInstance?.speech?.id}">${evaluationInstance?.speech?.speaker}</g:link></span>
