	...
	<body>
		...
		<div id="show-userRole" class="content scaffold-show" role="main">
			...
			<ol class="property-list userRole">
				...
				<g:if test="${userRoleInstance?.member}">
				<li class="fieldcontain">
					<span id="member-label" class="property-label"><g:message code="userRole.member.label" default="Member" /></span>
					
						<span class="property-value"
                              aria-labelledby="member-label"><g:link
                                controller="member" action="show" id="${userRoleInstance?.member?.id}">${userRoleInstance?.member?.name}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="role-label" class="property-label"><g:message code="userRole.role.label" default="Role" /></span>
						...
						<span class="property-value"
                              aria-labelledby="role-label"><g:link
                                controller="role" action="show" id="${userRoleInstance?.role?.id}">${userRoleInstance?.role?.name}</g:link></span>
