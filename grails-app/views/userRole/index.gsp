		...
		<div id="list-userRole" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="userRole.member.label" default="Member" /></th>
				...
				<g:each in="${userRoleInstanceList}" status="i" var="userRoleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show"
                                    id="${userRoleInstance.id}">${fieldValue(bean: userRoleInstance, field: "member.name")}</g:link></td>
					
						<td>${fieldValue(bean: userRoleInstance, field:
                                "role.name")}</td>
