...
<table class="code_table">
    ...
    <tr>
        ...
        <td rowspan="2">
            <g:pdfLink url="/pdf/demo2.gsp"
                       filename="sample.pdf">sample.pdf</g:pdfLink>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td rowspan="2">
            <g:pdfLink url="/pdf/demo2.gsp" filename="sample.pdf" icon="true"
                       class="myPdfLink">Custom link</g:pdfLink>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td rowspan="2">
            <g:pdfLink pdfController="pdf"
                       pdfAction="demo2">GSP as PDF</g:pdfLink>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td rowspan="2">
            <g:pdfLink pdfController="pdf" pdfAction="demo2"
                       pdfId="65432">GSP as PDF</g:pdfLink>
        </td>
    </tr>
    <tr>
        <td>
...
<table class="code_table">
    ...
    <tr>
        ...
        <td rowspan="2">
            <g:pdfForm controller="pdf" action="demo3" id="1942" method="post"
                       filename="sample.pdf">
                food:<br/>
                <g:textField name="food" size="10"/>
                <g:submitButton name="printPdf" value="pdf"/>
