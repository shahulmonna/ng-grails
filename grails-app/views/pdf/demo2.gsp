...
<img src="<g:resource dir='images' file='laptop.jpg'/>" alt="laptop"
     title="laptop"/>

<form>
    <p>checkbox:
    %{--	checkboxes used to cause an error in pdf generation, but now they simply don't show up...   --}%
        <input type="checkbox" checked="checked" name="sample_box"
               title="sample_box"/>
    </p>
    %{--    text field sample   --}%
    <p>Text Input:
...
<img src="http://system76.com/images/nb1_front_med.jpg" alt="laptop2"
     title="laptop2"/>
