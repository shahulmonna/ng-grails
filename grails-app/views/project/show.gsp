	...
	<body>
		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
				...
				<g:if test="${projectInstance?.educationProgram}">
				<li class="fieldcontain">
					<span id="educationProgram-label" class="property-label"><g:message code="project.educationProgram.label" default="Education Program" /></span>
					
						<span class="property-value"
                              aria-labelledby="educationProgram-label"><g:link controller="educationProgram" action="show" id="${projectInstance?.educationProgram?.id}">${projectInstance?.educationProgram?.name}</g:link></span>
